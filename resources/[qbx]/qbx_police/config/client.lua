return {
    ...
    radars = {
        ...
        enableRadars = true,
        useMPH = false, -- If true, it uses the imperial system. If false, it uses the metric system.
        locations = {
            {coords = vec4(-623.44421386719, -823.08361816406, 25.25704574585, 145.0), speedlimit = 70},
            {coords = vec4(-652.44421386719, -854.08361816406, 24.55704574585, 325.0), speedlimit = 100},
            {coords = vec4(1623.0114746094, 1068.9924316406, 80.903594970703, 84.0), speedlimit = 130},
            {coords = vec4(-2604.8994140625, 2996.3391113281, 27.528566360474, 175.0), speedlimit = 130},
            {coords = vec4(2136.65234375, -591.81469726563, 94.272926330566, 318.0), speedlimit = 130},
            {coords = vec4(2117.5764160156, -558.51013183594, 95.683128356934, 158.0), speedlimit = 130},
            {coords = vec4(406.89505004883, -969.06286621094, 29.436267852783, 33.0), speedlimit = 70},
            {coords = vec4(657.315, -218.819, 44.06, 320.0), speedlimit = 130},
            {coords = vec4(2118.287, 6040.027, 50.928, 172.0), speedlimit = 130},
            {coords = vec4(-106.304, -1127.5530, 30.778, 230.0), speedlimit = 70},
            {coords = vec4(-823.3688, -1146.980, 8.0, 300.0), speedlimit = 70},
        },
    },
